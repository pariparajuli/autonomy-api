...
func (m *MockAutonomyCore) UpdateAccountGeoPosition(accountNumber string, latitude, longitude float64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateAccountGeoPosition", accountNumber, latitude, longitude)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateAccountGeoPosition indicates an expected call of UpdateAccountGeoPosition
func (mr *MockAutonomyCoreMockRecorder) UpdateAccountGeoPosition(accountNumber, latitude, longitude interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateAccountGeoPosition", reflect.TypeOf((*MockAutonomyCore)(nil).UpdateAccountGeoPosition), accountNumber, latitude, longitude)
}
...
func (m *MockAutonomyCore) RequestHelp(accountNumber, subject, text string) (*schema.HelpRequest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RequestHelp", accountNumber, subject, text)
...
func (mr *MockAutonomyCoreMockRecorder) RequestHelp(accountNumber, subject, text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RequestHelp", reflect.TypeOf((*MockAutonomyCore)(nil).RequestHelp), accountNumber, subject, text)
}

// AnswerHelp mocks base method
func (m *MockAutonomyCore) AnswerHelp(accountNumber, helpID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AnswerHelp", accountNumber, helpID)
	ret0, _ := ret[0].(error)
	return ret0
}

// AnswerHelp indicates an expected call of AnswerHelp
func (mr *MockAutonomyCoreMockRecorder) AnswerHelp(accountNumber, helpID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AnswerHelp", reflect.TypeOf((*MockAutonomyCore)(nil).AnswerHelp), accountNumber, helpID)
}
